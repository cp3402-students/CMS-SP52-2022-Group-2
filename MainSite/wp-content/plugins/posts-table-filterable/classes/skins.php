 ...
 * TABLEON Skins
 *
 * Handles skins for [tableon] shortcodes
 *
 * @since   1.0.0
 */
if (!defined('ABSPATH')) {
...
class TABLEON_Skins {
    ...
    public function __construct() {
        $this->skin_folder = TABLEON_PATH . 'skins/';
    }
    ...
    public function get_skins() {
        $skins = [
            'default' => esc_html__('Default', 'posts-table-filterable'),
        ];
    ...
    public function get($table_id) {
        ...
        if (tableon()->tables->get($table_id)) {
            $skin = tableon()->tables->get($table_id)['skin'];
    ...
    private function get_wp_theme_dir() {
        return get_stylesheet_directory() . '/tableon-skins/';
    }
