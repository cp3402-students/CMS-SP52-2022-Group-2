...
3. When the popup appears select the ZIP file from your desktop. (The 'x.x.x' in the archive file name will change depending on the current version number).
...
* Improvement: Updated Help section
* Tested up to: 5.6
