...
function fast_press_customize_register_content( $wp_customize ) {
/**
 * Recent Posts
 */
		$wp_customize->add_section( 'seos_content_section' , array(
			'title'       => __( 'Content Options', 'fast-press' ),
			'priority'    => 2,	
		...
		$wp_customize->add_control( 'content_max_width', array(
		  ...
		  'label' => __( 'Content max width', 'fast-press' ),
		  'input_attrs' => array(
			'min' => 1210,
			'max' => 2000,
			'step' => 1,
		 ...
		 $wp_customize->add_control( 'content_padding', array(
		  ...
		  'label' => __( 'Content Padding', 'fast-press' ),
		  'input_attrs' => array(
			'min' => 0,
			'max' => 100,
			'step' => 1,
		...
		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'hide_home_content', array(
			'label'    => __( 'Hide sidebar and content on home page', 'fast-press' ),
			'section'  => 'seos_content_section',
			'priority'    => 1,				
		...
		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'hide_featured', array(
			'label'    => __( 'Show featured images on all single pages.', 'fast-press' ),
			'section'  => 'seos_content_section',
			'priority'    => 1,				
...
add_action( 'customize_register', 'fast_press_customize_register_content' );
/********************************************
* Content Styles
*********************************************/ 	
function fast_press_content_styles () {
...
add_action( 'wp_enqueue_scripts', 'fast_press_content_styles' );